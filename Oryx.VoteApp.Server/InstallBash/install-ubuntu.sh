...
sudo sh -c 'echo -e "[packages-microsoft-com-prod]\nname=packages-microsoft-com-prod \nbaseurl= https://packages.microsoft.com/apt-getrepos/microsoft-rhel7.3-prod\nenabled=1\ngpgcheck=1\ngpgkey=https://packages.microsoft.com/keys/microsoft.asc" > /etc/apt-get.repos.d/dotnetdev.repo'

sudo apt-get update 
sudo apt-get install libunwind libicu dotnet-sdk-2.1.4
...
command= #!/bin/bash -c "dotnet Oryx.VoteApp.Server.dll"
...
user=root
stopsignal=INT' > /etc/supervisord.d/voteApp
...
server {
        ...
        listen [::]:80 default_server;
        server_name hk.voteapp.oryxl.com;
